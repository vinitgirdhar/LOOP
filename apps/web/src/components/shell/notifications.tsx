...
export function NotificationBell({ workspaceId }: { workspaceId: string }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="fade-in fixed inset-x-2 top-14 z-50 overflow-hidden rounded-xl border bg-[var(--surface)] shadow-[var(--shadow-lg)] sm:absolute sm:inset-x-auto sm:right-0 sm:top-auto sm:mt-1 sm:w-88 sm:max-w-[22rem]">
          ...
          <div className="scroll-thin max-h-[70vh] overflow-y-auto sm:max-h-96">
